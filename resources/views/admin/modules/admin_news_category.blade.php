<div class="card card-body border-0 shadow table-wrapper table-responsive">
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <form action="{{ route('news_category.destroy', $n->id) }}" method="post">
                            @csrf
                            ...
                            <div class="dropdown-menu py-0">
                                <a class="dropdown-item" href="{{ route('news_category.edit', $n->id) }}"><span class="fas fa-edit me-2"></span>Редактировать</a>
                                @method('DELETE')
    ...
    <div class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
        {{ $news_category->onEachSide(0)->links() }}
    </div>
</div>